/* Arma lab/abecedario-atractores/index.html.
...
const TITULO = 'Abecedario de atractores — Lab — B&N SOLUTIONS';
const DESC = 'Veintiséis letras buscadas dentro de atractores caóticos: sep-CMA-ES sobre los ' +
             'parámetros del sistema y sobre el ángulo desde el que se lo mira. Cuáles salen, ' +
             'cuáles no, y por qué.';
...
<head>
  ...
  <link rel="canonical" href="https://bnsolutions.cl/lab/abecedario-atractores">
  <meta property="og:title" content="Abecedario de atractores — Lab">
