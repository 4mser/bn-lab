/* Incompressible fluid — the Navier-Stokes equations on the GPU.
   ...
   Changes here: it runs as a BN Lab Simulations experiment (sized, paused and themed by
...
const unsupported = message => Object.assign(new Error('bn-lab-simulations/fluid: ' + message), { code: 'WEBGL_UNSUPPORTED' });
